...
@private NSInteger timeToWaitBeforeClose;
...
/**
 * Overrides the time the write: method will wait after writing data to the stream. The default time is 60ms. This method is used to adapt to different
...
/**
 * Overrides the time the close: method will wait before closing the connection. The default time is 5000ms. This method is used to adapt to different
 * Bluetooth radio performance requirements. If you notice an issue writing bytes, try increasing this time.
 *
 * @param aTimeInMs Time in milliseconds to wait between writes.
 */
