...
struct MaterialChecklistView: View {
    ...
    @State private var remainingBoxes: [String: Int] = [:]
        ...
        .sheet(isPresented: $showingMultiMaterialSheet) {
            ...
            if let objectID = selectedObjectID {
                ...
                MultipleMaterialSelectionView(
                    ...
                    for (material, quantity, boxes) in results {

                        addMaterial(objectID: objectID, material: material, quantity: quantity, boxes: boxes)
                ...
                SingleMaterialDistributionView(
                    ...
                    for (objID, qty) in distribution {
                        ...
                        if qty > 0 {
                            ...
                            addMaterial(objectID: objID, material: singleMaterial, quantity: qty, boxes: 0)
    ...
    private func addMaterial(objectID: String, material: String, quantity: Int, boxes: Int) {
    ...
    private func sendData(billAllAsD: Bool) {
        ...
        // Recorremos cada objectID en orden
...
struct MultipleMaterialSelectionView: View {
    ...
    var remainingBoxes: [String: Int]




    var onCompletion: ([(String, Int, Int)]) -> Void
    ...
    @State private var boxesForSelected: [String: String] = [:]
                ...
                if step == 1 {
                    ...
                    List(selectedMaterials, id: \.self) { material in
                        ...
                        HStack {
                            ...
                            TextField("Boxes", text: Binding(

                                get: { boxesForSelected[material] ?? "" },

                                set: { boxesForSelected[material] = $0 }
                    ...
                    HStack {
                        ...
                        Button("Add All") {
                            ...
                            for mat in selectedMaterials {
                                ...
                                let textBoxes = boxesForSelected[mat] ?? "0"

                                let intQty = Int(textQty) ?? 0

                                let intBoxes = Int(textBoxes) ?? 0

                                finalArray.append((mat, intQty, intBoxes))

                                //finalArray.append((mat, textQty + "" + textBoxes))
